            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    QueryArtworkWidget(
                      ...
                      id: BlocProvider.of<ArtistCubit>(context).artistModel.id,
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            '- ${BlocProvider.of<ArtistCubit>(context).artistModel.numberOfAlbums} Albums -',
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: const TextStyle(
                          ...
                          Text(
                            '- ${BlocProvider.of<ArtistCubit>(context).artistModel.numberOfTracks} Songs -',
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: const TextStyle(
                              fontWeight: FontWeight.w300,
              ...
              Expanded(
                child: songListWidget(
                  context,
                  BlocProvider.of<ArtistCubit>(context).songList,
                ),
              ),
            ],
          ),
